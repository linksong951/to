...
start  "" "C:\Program Files (x86)\Microsoft\Edge\Application\msedge.exe" "https://github.com/"
start  "" "C:\Program Files (x86)\Microsoft\Edge\Application\msedge.exe" "https://gitee.com/"
